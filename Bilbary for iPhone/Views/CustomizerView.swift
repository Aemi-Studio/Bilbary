//
//  CustomizerViewiPhone.swift
//  Bilbary
//
//  Created by Shohjakhon Mamadaliev on 28/02/25.
//
...
struct CustomizationView: View {
    ...
    @State private var customizer: RCustomizerModel = .shared
    @State private var selectedId: UUID?
    @State private var styles: [RCPreset] = RCPreset.defaults
    
    private var columns: [GridItem] = Array(
        repeating: GridItem(.flexible(minimum: 48, maximum: .infinity), spacing: 4, alignment: .center),
        count: 3
    )
